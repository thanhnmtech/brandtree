        ...
        <div class="tw-bg-white tw-rounded-2xl tw-shadow-sm tw-p-6">
            ...
            <form action="{{ route('brands.payments.store', $brand) }}" method="POST">
                ...
                <div class="tw-space-y-3 tw-mb-6">
                    <label class="tw-flex tw-items-center tw-p-4 tw-border tw-border-[#16a249] tw-rounded-xl tw-bg-green-50 tw-cursor-pointer">
                        <input type="radio" name="payment_method" value="bank_transfer" checked class="tw-w-4 tw-h-4 tw-text-[#16a249]">
                        <div class="tw-ml-3">
                            <span class="tw-font-medium tw-text-gray-800">Chuyển khoản ngân hàng</span>
                            <p class="tw-text-sm tw-text-gray-500">Chuyển khoản qua Sepay QR</p>
                        </div>
                    </label>
                </div>

                <button type="submit" class="tw-w-full tw-py-3 tw-bg-[#16a249] tw-text-white tw-rounded-lg tw-font-medium hover:tw-bg-[#138a3e] tw-transition">
                    Tiến hành thanh toán
                </button>
            </form>

            <p class="tw-text-xs tw-text-gray-500 tw-text-center tw-mt-4">
                Bằng việc thanh toán, bạn đồng ý với <a href="#" class="tw-text-[#16a249] hover:tw-underline">Điều khoản dịch vụ</a>
            </p>
        </div>
    </div>
