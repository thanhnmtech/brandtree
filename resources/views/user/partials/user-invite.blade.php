<!-- POPUP WRAPPER -->
<div
  class="tw-bg-white tw-rounded-2xl tw-w-[420px] tw-max-w-[90%] tw-max-h-[90dvh] tw-overflow-y-hidden tw-p-6 tw-relative tw-border tw-border-gray-300 tw-z-[9999]"
>
  <button
    type="button"
    data-close-modal="close-overlay"
  ...
  <!-- Email -->
  <label class="tw-block tw-font-medium tw-mt-5 tw-mb-1 tw-text-sm"
    >Email thành viên</label
  >
  <input
    type="email"
  ...
  <div class="tw-space-y-3">
    <!-- Admin -->
    <label
      class="tw-flex tw-items-start tw-gap-3 tw-cursor-pointer tw-select-none"
    >
      <input
        type="radio"
        name="role"
  ...
  <!-- Permission Area -->
  <div
    class="tw-bg-[#F8F9F7] tw-border tw-border-[#E0EAE6] tw-rounded-xl tw-p-4 tw-mt-5"
  >
    ...
    <div class="tw-space-y-4">
      ...
      <div class="tw-flex tw-items-center tw-justify-between">
        <div class="tw-flex tw-items-center tw-gap-2">
          ...
          <span class="tw-text-gray-800 tw-font-medium tw-text-sm"
            >Gốc Cây (Nền tảng)</span
          >
        </div>
        <button
