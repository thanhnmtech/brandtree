<div class="tw-flex tw-flex-col">
  ...
  >
    <div>
      <img
        src="./assets/img/logo-resultbar.svg"
  ...
  >
    ...
    >
      <div class="tw-flex-1 tw-min-w-0">
        <div
          class="tw-text-sm tw-font-semibold tw-truncate tw-overflow-hidden tw-whitespace-nowrap"
        >
      ...
      <div>
        <div class="tw-w-full tw-h-[6px] tw-bg-[#e8eeeb] tw-rounded-full">
          <div
            class="tw-h-full tw-bg-[linear-gradient(90deg,#329C59_-83.33%,#45C974_80.61%)] tw-rounded-l-full"
            style="width: 15%"
          ></div>
        </div>
      </div>
