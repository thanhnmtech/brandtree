        ...
        <div class="tw-flex tw-flex-col tw-gap-[15px] tw-mx-[26px] tw-my-[13px] md:tw-flex-row">
            ...
            <div
                ...
                <div class="tw-flex tw-flex-row tw-justify-between tw-text-black tw-text-[18px] tw-font-semibold">
                    <span>{{ __('messages.dashboard.active_brands') }}</span>
                    <img src="{{ asset('assets/img/icon-than-gray.svg') }}" alt="total" class="tw-w-[24px] tw-h-[24px]" />
                </div>
                ...
                <div class="tw-mt-[10px] tw-text-[14px] tw-text-[#829B99]">
                    {{ __('messages.dashboard.total_brands_desc') }}
                </div>
            </div>
            ...
            <div
                class="tw-bg-white tw-rounded-[7px] tw-border-[2px] tw-border-[#E0EAE6] tw-shadow-[0_4px_4px_rgba(0,0,0,0.05)] tw-p-[20px] tw-flex tw-flex-col tw-justify-between tw-flex-1">
                <div class="tw-flex tw-flex-row tw-justify-between tw-text-black tw-text-[18px] tw-font-semibold">
                    <span>{{ __('messages.dashboard.need_care') }}</span>
                    <img src="{{ asset('assets/img/icon-warning-red.svg') }}" alt="warning" class="tw-w-[24px] tw-h-[24px]" />
                </div>
                <div class="tw-mt-[6px] tw-text-[30px] tw-font-bold tw-text-[#DC282E]" data-stat="seedling">
                    {{ $seedlingCount }}
                </div>
                <div class="tw-mt-[10px] tw-text-[14px] tw-text-[#829B99]">
                    {{ __('messages.dashboard.need_care_desc') }}
                </div>
            </div>
            ...
            <div
                class="tw-bg-white tw-rounded-[7px] tw-border-[2px] tw-border-[#E0EAE6] tw-shadow-[0_4px_4px_rgba(0,0,0,0.05)] tw-p-[20px] tw-flex tw-flex-col tw-justify-between tw-flex-1">
                <div class="tw-flex tw-flex-row tw-justify-between tw-text-black tw-text-[18px] tw-font-semibold">
                    <span>{{ __('messages.dashboard.growing') }}</span>
                    <img src="{{ asset('assets/img/icon-o\'clock-orange.svg') }}" alt="grow" class="tw-w-[24px] tw-h-[24px]" />
                </div>
                <div class="tw-mt-[6px] tw-text-[30px] tw-font-bold tw-text-[#F59F0A]" data-stat="growing">
                    {{ $growingCount }}
                </div>
                <div class="tw-mt-[10px] tw-text-[14px] tw-text-[#829B99]">
                    {{ __('messages.dashboard.growing_desc') }}
                </div>
            </div>
            ...
            <div
                class="tw-bg-white tw-rounded-[7px] tw-border-[2px] tw-border-[#E0EAE6] tw-shadow-[0_4px_4px_rgba(0,0,0,0.05)] tw-p-[20px] tw-flex tw-flex-col tw-justify-between tw-flex-1">
                <div class="tw-flex tw-flex-row tw-justify-between tw-text-black tw-text-[18px] tw-font-semibold">
                    <span>{{ __('messages.dashboard.completed') }}</span>
                    <img src="{{ asset('assets/img/icon-success-green.svg') }}" alt="ok" class="tw-w-[24px] tw-h-[24px]" />
                </div>
                <div class="tw-mt-[6px] tw-text-[30px] tw-font-bold tw-text-[#1AA24C]" data-stat="completed">
                    {{ $completedCount }}
                </div>
                <div class="tw-mt-[10px] tw-text-[14px] tw-text-[#829B99]">
                    {{ __('messages.dashboard.completed_desc') }}
                </div>
            </div>
        </div>
        ...
        <div
            ...
            <div class="tw-relative tw-w-[680px] tw-max-w-full">
                <input
                    ...
                    placeholder="{{ __('messages.dashboard.search_placeholder') }}" />
                <img src="{{ asset('assets/img/look-up-vector.svg') }}" alt="look-up"
            ...
            <div
                ...
                <div
                    ...
                    <select name="status"
                        ...
                        <option value="">{{ __('messages.dashboard.all_status') }}</option>
                        <option value="seedling" {{ ($status ?? '') === 'seedling' ? 'selected' : '' }}>{{ __('messages.dashboard.status_seedling') }}</option>
                        <option value="growing" {{ ($status ?? '') === 'growing' ? 'selected' : '' }}>{{ __('messages.dashboard.status_growing') }}</option>
                        <option value="completed" {{ ($status ?? '') === 'completed' ? 'selected' : '' }}>{{ __('messages.dashboard.status_completed') }}</option>
                    </select>
                    <img src="{{ asset('assets/img/drop-down-vector.svg') }}" alt="dropdown"
                ...
                <div
                    ...
                    <select name="order_by"
                        ...
                        <option value="updated_at" {{ ($orderBy ?? 'updated_at') === 'updated_at' ? 'selected' : '' }}>{{ __('messages.dashboard.sort_updated') }}</option>
                        <option value="created_at" {{ ($orderBy ?? '') === 'created_at' ? 'selected' : '' }}>{{ __('messages.dashboard.sort_newest') }}</option>
                    </select>
                    <img src="{{ asset('assets/img/drop-down-vector.svg') }}" alt="dropdown"
                        class="tw-absolute tw-right-[10px] tw-top-1/2 tw--translate-y-1/2 tw-w-[16px] tw-h-[16px] tw-pointer-events-none" />
                </div>
