...
return [
    ...
    */
    ...
    'brand_show' => [
        ...
        'trunk_not_completed' => 'Hoàn thành giai đoạn Thân để khẳng định bản sắc và tiếng nói khác biệt',
        'trunk_defined' => 'Nhận diện thương hiệu đã được khẳng định',
        'root_not_completed' => 'Hoàn thành giai đoạn Gốc để xác định giá trị cốt lõi',
        'root_defined' => 'Giá trị cốt lõi đã được xác định',
        'brand_health' => 'Sức Khỏe Thương Hiệu',
        'canopy_not_started' => 'Hãy bắt đầu giai đoạn Tán - Kích hoạt truyền thông, chiếm lĩnh tâm trí',
