...
return [
    ...
    */
    ...
    'brand_show' => [
        ...
        'trunk_not_completed' => 'Complete the Trunk stage to define identity and unique voice',
        'trunk_defined' => 'Brand identity has been defined',
        'root_not_completed' => 'Complete the Root stage to define core values',
        'root_defined' => 'Core values have been defined',
        'brand_health' => 'Brand Health',
        'canopy_not_started' => 'Start the Canopy Phase – Activate communications and capture mindshare.',
        'next_step' => 'Next Step',
