...
class UpdateBriefPrompts extends Command
{
    protected $signature = 'app:update-brief-prompts';
    protected $description = 'Update brief_prompts with stricter summarization requirements';
